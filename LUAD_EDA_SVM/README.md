Data processing and model training (linear SVM) using gene expression and DNA methylation data from healthy and cancerous lung tissue (lung adenocarcinoma; https://portal.gdc.cancer.gov/projects/TCGA-LUAD). 
